...
,SUM(CASE WHEN TRIM(UPPER(PROD.PLANEXTRACASHINPUT)) IS NULL AND TRIM(UPPER(UAT.PLANEXTRACASHINPUT))="" THEN 1 ELSE 0 END) AS DIFF_PLANEXTRACASHINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.PLANEXTRACASHVALUE)) IS NULL AND TRIM(UPPER(UAT.PLANEXTRACASHVALUE))="" THEN 1 ELSE 0 END) AS DIFF_PLANEXTRACASHVALUE
