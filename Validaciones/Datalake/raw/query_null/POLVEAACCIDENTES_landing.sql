...
,SUM(CASE WHEN TRIM(UPPER(PROD.PLANVEAACCINPUT)) IS NULL AND TRIM(UPPER(UAT.PLANVEAACCINPUT))="" THEN 1 ELSE 0 END) AS DIFF_PLANVEAACCINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.PLANVEAACCVALUE)) IS NULL AND TRIM(UPPER(UAT.PLANVEAACCVALUE))="" THEN 1 ELSE 0 END) AS DIFF_PLANVEAACCVALUE
,SUM(CASE WHEN TRIM(UPPER(PROD.NUMPLANINTERVAINPUT)) IS NULL AND TRIM(UPPER(UAT.NUMPLANINTERVAINPUT))="" THEN 1 ELSE 0 END) AS DIFF_NUMPLANINTERVAINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.NUMPLANINTERVAVALUE)) IS NULL AND TRIM(UPPER(UAT.NUMPLANINTERVAVALUE))="" THEN 1 ELSE 0 END) AS DIFF_NUMPLANINTERVAVALUE
