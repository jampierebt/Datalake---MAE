...
,SUM(CASE WHEN TRIM(UPPER(PROD.FECHAPROXIMACADUCIDADINPUT)) IS NULL AND TRIM(UPPER(UAT.FECHAPROXIMACADUCIDADINPUT))="" THEN 1 ELSE 0 END) AS DIFF_FECHAPROXIMACADUCIDADINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.FECHAPROXIMACADUCIDADVALUE)) IS NULL AND TRIM(UPPER(UAT.FECHAPROXIMACADUCIDADVALUE))="" THEN 1 ELSE 0 END) AS DIFF_FECHAPROXIMACADUCIDADVALUE
