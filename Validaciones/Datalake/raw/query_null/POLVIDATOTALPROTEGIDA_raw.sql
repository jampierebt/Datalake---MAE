...
,SUM(CASE WHEN TRIM(UPPER(PROD.COBFALLECACCTPINPUT)) IS NULL AND TRIM(UPPER(UAT.COBFALLECACCTPINPUT))="" THEN 1 ELSE 0 END) AS DIFF_COBFALLECACCTPINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.COBFALLECACCTPVALUE)) IS NULL AND TRIM(UPPER(UAT.COBFALLECACCTPVALUE))="" THEN 1 ELSE 0 END) AS DIFF_COBFALLECACCTPVALUE
,SUM(CASE WHEN TRIM(UPPER(PROD.COBFALLECACCTAINPUT)) IS NULL AND TRIM(UPPER(UAT.COBFALLECACCTAINPUT))="" THEN 1 ELSE 0 END) AS DIFF_COBFALLECACCTAINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.COBFALLECACCTAVALUE)) IS NULL AND TRIM(UPPER(UAT.COBFALLECACCTAVALUE))="" THEN 1 ELSE 0 END) AS DIFF_COBFALLECACCTAVALUE
...
,SUM(CASE WHEN TRIM(UPPER(PROD.COBINDEMHOSPINPUT)) IS NULL AND TRIM(UPPER(UAT.COBINDEMHOSPINPUT))="" THEN 1 ELSE 0 END) AS DIFF_COBINDEMHOSPINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.COBINDEMHOSPVALUE)) IS NULL AND TRIM(UPPER(UAT.COBINDEMHOSPVALUE))="" THEN 1 ELSE 0 END) AS DIFF_COBINDEMHOSPVALUE
,SUM(CASE WHEN TRIM(UPPER(PROD.COBINDEMHOSPUCIINPUT)) IS NULL AND TRIM(UPPER(UAT.COBINDEMHOSPUCIINPUT))="" THEN 1 ELSE 0 END) AS DIFF_COBINDEMHOSPUCIINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.COBINDEMHOSPUCIVALUE)) IS NULL AND TRIM(UPPER(UAT.COBINDEMHOSPUCIVALUE))="" THEN 1 ELSE 0 END) AS DIFF_COBINDEMHOSPUCIVALUE
