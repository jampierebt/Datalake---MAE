...
,SUM(CASE WHEN TRIM(UPPER(PROD.PROFESIONACTIVIDADINPUT)) IS NULL AND TRIM(UPPER(UAT.PROFESIONACTIVIDADINPUT))="" THEN 1 ELSE 0 END) AS DIFF_PROFESIONACTIVIDADINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.PROFESIONACTIVIDADVALUE)) IS NULL AND TRIM(UPPER(UAT.PROFESIONACTIVIDADVALUE))="" THEN 1 ELSE 0 END) AS DIFF_PROFESIONACTIVIDADVALUE
,SUM(CASE WHEN TRIM(UPPER(PROD.CLASEACCPERSINPUT)) IS NULL AND TRIM(UPPER(UAT.CLASEACCPERSINPUT))="" THEN 1 ELSE 0 END) AS DIFF_CLASEACCPERSINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.CLASEACCPERSVALUE)) IS NULL AND TRIM(UPPER(UAT.CLASEACCPERSVALUE))="" THEN 1 ELSE 0 END) AS DIFF_CLASEACCPERSVALUE
...
,SUM(CASE WHEN TRIM(UPPER(PROD.TIPOENDOSOPROPACCINPUT)) IS NULL AND TRIM(UPPER(UAT.TIPOENDOSOPROPACCINPUT))="" THEN 1 ELSE 0 END) AS DIFF_TIPOENDOSOPROPACCINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.TIPOENDOSOPROPACCVALUE)) IS NULL AND TRIM(UPPER(UAT.TIPOENDOSOPROPACCVALUE))="" THEN 1 ELSE 0 END) AS DIFF_TIPOENDOSOPROPACCVALUE
