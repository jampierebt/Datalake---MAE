SELECT SUM(CASE WHEN TRIM(UPPER(PROD.EDADMINIMAINPUT)) IS NULL AND TRIM(UPPER(UAT.EDADMINIMAINPUT))="" THEN 1 ELSE 0 END) AS DIFF_EDADMINIMAINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.EDADMINIMAVALUE)) IS NULL AND TRIM(UPPER(UAT.EDADMINIMAVALUE))="" THEN 1 ELSE 0 END) AS DIFF_EDADMINIMAVALUE
,SUM(CASE WHEN TRIM(UPPER(PROD.EDADMAXIMAINPUT)) IS NULL AND TRIM(UPPER(UAT.EDADMAXIMAINPUT))="" THEN 1 ELSE 0 END) AS DIFF_EDADMAXIMAINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.EDADMAXIMAVALUE)) IS NULL AND TRIM(UPPER(UAT.EDADMAXIMAVALUE))="" THEN 1 ELSE 0 END) AS DIFF_EDADMAXIMAVALUE
...
,SUM(CASE WHEN TRIM(UPPER(PROD.EDADPERMANINPUT)) IS NULL AND TRIM(UPPER(UAT.EDADPERMANINPUT))="" THEN 1 ELSE 0 END) AS DIFF_EDADPERMANINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.EDADPERMANVALUE)) IS NULL AND TRIM(UPPER(UAT.EDADPERMANVALUE))="" THEN 1 ELSE 0 END) AS DIFF_EDADPERMANVALUE
...
,SUM(CASE WHEN TRIM(UPPER(PROD.APEPATERNOBENCIVINPUT)) IS NULL AND TRIM(UPPER(UAT.APEPATERNOBENCIVINPUT))="" THEN 1 ELSE 0 END) AS DIFF_APEPATERNOBENCIVINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.APEPATERNOBENCIVVALUE)) IS NULL AND TRIM(UPPER(UAT.APEPATERNOBENCIVVALUE))="" THEN 1 ELSE 0 END) AS DIFF_APEPATERNOBENCIVVALUE
,SUM(CASE WHEN TRIM(UPPER(PROD.APEMATERNOBENCIVINPUT)) IS NULL AND TRIM(UPPER(UAT.APEMATERNOBENCIVINPUT))="" THEN 1 ELSE 0 END) AS DIFF_APEMATERNOBENCIVINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.APEMATERNOBENCIVVALUE)) IS NULL AND TRIM(UPPER(UAT.APEMATERNOBENCIVVALUE))="" THEN 1 ELSE 0 END) AS DIFF_APEMATERNOBENCIVVALUE
,SUM(CASE WHEN TRIM(UPPER(PROD.NOMBRESBENCIVINPUT)) IS NULL AND TRIM(UPPER(UAT.NOMBRESBENCIVINPUT))="" THEN 1 ELSE 0 END) AS DIFF_NOMBRESBENCIVINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.NOMBRESBENCIVVALUE)) IS NULL AND TRIM(UPPER(UAT.NOMBRESBENCIVVALUE))="" THEN 1 ELSE 0 END) AS DIFF_NOMBRESBENCIVVALUE
,SUM(CASE WHEN TRIM(UPPER(PROD.FECHANACBENCIVINPUT)) IS NULL AND TRIM(UPPER(UAT.FECHANACBENCIVINPUT))="" THEN 1 ELSE 0 END) AS DIFF_FECHANACBENCIVINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.FECHANACBENCIVVALUE)) IS NULL AND TRIM(UPPER(UAT.FECHANACBENCIVVALUE))="" THEN 1 ELSE 0 END) AS DIFF_FECHANACBENCIVVALUE
,SUM(CASE WHEN TRIM(UPPER(PROD.DOCIDENTIDADBENCIVINPUT)) IS NULL AND TRIM(UPPER(UAT.DOCIDENTIDADBENCIVINPUT))="" THEN 1 ELSE 0 END) AS DIFF_DOCIDENTIDADBENCIVINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.DOCIDENTIDADBENCIVVALUE)) IS NULL AND TRIM(UPPER(UAT.DOCIDENTIDADBENCIVVALUE))="" THEN 1 ELSE 0 END) AS DIFF_DOCIDENTIDADBENCIVVALUE
,SUM(CASE WHEN TRIM(UPPER(PROD.PARENTESCOBENCIVINPUT)) IS NULL AND TRIM(UPPER(UAT.PARENTESCOBENCIVINPUT))="" THEN 1 ELSE 0 END) AS DIFF_PARENTESCOBENCIVINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.PARENTESCOBENCIVVALUE)) IS NULL AND TRIM(UPPER(UAT.PARENTESCOBENCIVVALUE))="" THEN 1 ELSE 0 END) AS DIFF_PARENTESCOBENCIVVALUE
,SUM(CASE WHEN TRIM(UPPER(PROD.DISTRIBUCIONBENCIVINPUT)) IS NULL AND TRIM(UPPER(UAT.DISTRIBUCIONBENCIVINPUT))="" THEN 1 ELSE 0 END) AS DIFF_DISTRIBUCIONBENCIVINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.DISTRIBUCIONBENCIVVALUE)) IS NULL AND TRIM(UPPER(UAT.DISTRIBUCIONBENCIVVALUE))="" THEN 1 ELSE 0 END) AS DIFF_DISTRIBUCIONBENCIVVALUE
,SUM(CASE WHEN TRIM(UPPER(PROD.APEPATERNOBENCVINPUT)) IS NULL AND TRIM(UPPER(UAT.APEPATERNOBENCVINPUT))="" THEN 1 ELSE 0 END) AS DIFF_APEPATERNOBENCVINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.APEPATERNOBENCVVALUE)) IS NULL AND TRIM(UPPER(UAT.APEPATERNOBENCVVALUE))="" THEN 1 ELSE 0 END) AS DIFF_APEPATERNOBENCVVALUE
,SUM(CASE WHEN TRIM(UPPER(PROD.APEMATERNOBENCVINPUT)) IS NULL AND TRIM(UPPER(UAT.APEMATERNOBENCVINPUT))="" THEN 1 ELSE 0 END) AS DIFF_APEMATERNOBENCVINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.APEMATERNOBENCVVALUE)) IS NULL AND TRIM(UPPER(UAT.APEMATERNOBENCVVALUE))="" THEN 1 ELSE 0 END) AS DIFF_APEMATERNOBENCVVALUE
,SUM(CASE WHEN TRIM(UPPER(PROD.NOMBRESBENCVINPUT)) IS NULL AND TRIM(UPPER(UAT.NOMBRESBENCVINPUT))="" THEN 1 ELSE 0 END) AS DIFF_NOMBRESBENCVINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.NOMBRESBENCVVALUE)) IS NULL AND TRIM(UPPER(UAT.NOMBRESBENCVVALUE))="" THEN 1 ELSE 0 END) AS DIFF_NOMBRESBENCVVALUE
,SUM(CASE WHEN TRIM(UPPER(PROD.FECHANACBENCVINPUT)) IS NULL AND TRIM(UPPER(UAT.FECHANACBENCVINPUT))="" THEN 1 ELSE 0 END) AS DIFF_FECHANACBENCVINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.FECHANACBENCVVALUE)) IS NULL AND TRIM(UPPER(UAT.FECHANACBENCVVALUE))="" THEN 1 ELSE 0 END) AS DIFF_FECHANACBENCVVALUE
,SUM(CASE WHEN TRIM(UPPER(PROD.DOCIDENTIDADBENCVINPUT)) IS NULL AND TRIM(UPPER(UAT.DOCIDENTIDADBENCVINPUT))="" THEN 1 ELSE 0 END) AS DIFF_DOCIDENTIDADBENCVINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.DOCIDENTIDADBENCVVALUE)) IS NULL AND TRIM(UPPER(UAT.DOCIDENTIDADBENCVVALUE))="" THEN 1 ELSE 0 END) AS DIFF_DOCIDENTIDADBENCVVALUE
,SUM(CASE WHEN TRIM(UPPER(PROD.PARENTESCOBENCVINPUT)) IS NULL AND TRIM(UPPER(UAT.PARENTESCOBENCVINPUT))="" THEN 1 ELSE 0 END) AS DIFF_PARENTESCOBENCVINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.PARENTESCOBENCVVALUE)) IS NULL AND TRIM(UPPER(UAT.PARENTESCOBENCVVALUE))="" THEN 1 ELSE 0 END) AS DIFF_PARENTESCOBENCVVALUE
,SUM(CASE WHEN TRIM(UPPER(PROD.DISTRIBUCIONBENCVINPUT)) IS NULL AND TRIM(UPPER(UAT.DISTRIBUCIONBENCVINPUT))="" THEN 1 ELSE 0 END) AS DIFF_DISTRIBUCIONBENCVINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.DISTRIBUCIONBENCVVALUE)) IS NULL AND TRIM(UPPER(UAT.DISTRIBUCIONBENCVVALUE))="" THEN 1 ELSE 0 END) AS DIFF_DISTRIBUCIONBENCVVALUE
