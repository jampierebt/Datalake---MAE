...
,SUM(CASE WHEN TRIM(UPPER(PROD.SALDOPROMEDIOINPUT)) IS NULL AND TRIM(UPPER(UAT.SALDOPROMEDIOINPUT))="" THEN 1 ELSE 0 END) AS DIFF_SALDOPROMEDIOINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.SALDOPROMEDIOVALUE)) IS NULL AND TRIM(UPPER(UAT.SALDOPROMEDIOVALUE))="" THEN 1 ELSE 0 END) AS DIFF_SALDOPROMEDIOVALUE