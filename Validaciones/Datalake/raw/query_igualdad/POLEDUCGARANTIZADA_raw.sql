...
,SUM(CASE WHEN TRIM(UPPER(PROD.MONTOMORAINPUT))!=TRIM(UPPER(UAT.MONTOMORAINPUT)) THEN 1 ELSE 0 END) AS DIFF_MONTOMORAINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.MONTOMORAVALUE))!=TRIM(UPPER(UAT.MONTOMORAVALUE)) THEN 1 ELSE 0 END) AS DIFF_MONTOMORAVALUE
,SUM(CASE WHEN TRIM(UPPER(PROD.FECHAULTPRIMAPAGADAINPUT))!=TRIM(UPPER(UAT.FECHAULTPRIMAPAGADAINPUT)) THEN 1 ELSE 0 END) AS DIFF_FECHAULTPRIMAPAGADAINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.FECHAULTPRIMAPAGADAVALUE))!=TRIM(UPPER(UAT.FECHAULTPRIMAPAGADAVALUE)) THEN 1 ELSE 0 END) AS DIFF_FECHAULTPRIMAPAGADAVALUE
,SUM(CASE WHEN TRIM(UPPER(PROD.PRIMACOMERCIALANUALINPUT))!=TRIM(UPPER(UAT.PRIMACOMERCIALANUALINPUT)) THEN 1 ELSE 0 END) AS DIFF_PRIMACOMERCIALANUALINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.PRIMACOMERCIALANUALVALUE))!=TRIM(UPPER(UAT.PRIMACOMERCIALANUALVALUE)) THEN 1 ELSE 0 END) AS DIFF_PRIMACOMERCIALANUALVALUE
