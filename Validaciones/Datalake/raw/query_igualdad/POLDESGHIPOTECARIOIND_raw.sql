...
,SUM(CASE WHEN TRIM(UPPER(PROD.EMAILCONYINPUT))!=TRIM(UPPER(UAT.EMAILCONYINPUT)) THEN 1 ELSE 0 END) AS DIFF_EMAILCONYINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.EMAILCONYVALUE))!=TRIM(UPPER(UAT.EMAILCONYVALUE)) THEN 1 ELSE 0 END) AS DIFF_EMAILCONYVALUE
...
,SUM(CASE WHEN TRIM(UPPER(PROD.CORRELATIVOTITULARDPSINPUT))!=TRIM(UPPER(UAT.CORRELATIVOTITULARDPSINPUT)) THEN 1 ELSE 0 END) AS DIFF_CORRELATIVOTITULARDPSINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.CORRELATIVOTITULARDPSVALUE))!=TRIM(UPPER(UAT.CORRELATIVOTITULARDPSVALUE)) THEN 1 ELSE 0 END) AS DIFF_CORRELATIVOTITULARDPSVALUE
