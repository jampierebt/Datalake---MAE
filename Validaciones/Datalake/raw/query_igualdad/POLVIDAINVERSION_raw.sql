...
,SUM(CASE WHEN TRIM(UPPER(PROD.NUMEROPOLIZAFLEXINPUT))!=TRIM(UPPER(UAT.NUMEROPOLIZAFLEXINPUT)) THEN 1 ELSE 0 END) AS DIFF_NUMEROPOLIZAFLEXINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.NUMEROPOLIZAFLEXVALUE))!=TRIM(UPPER(UAT.NUMEROPOLIZAFLEXVALUE)) THEN 1 ELSE 0 END) AS DIFF_NUMEROPOLIZAFLEXVALUE
...
,SUM(CASE WHEN TRIM(UPPER(PROD.INDPRESTAMOVALUE))!=TRIM(UPPER(UAT.INDPRESTAMOVALUE)) THEN 1 ELSE 0 END) AS DIFF_INDPRESTAMOVALUE
...
FROM iter-data-storage-pv-uat.acsele_data.POLVIDAINVERSION_raw UAT 
INNER JOIN interseguro-data.acsele_data.POLVIDAINVERSION_raw PROD 
ON UAT.PK = PROD.PK