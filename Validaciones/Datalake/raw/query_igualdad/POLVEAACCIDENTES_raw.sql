...
,SUM(CASE WHEN TRIM(UPPER(PROD.PLANVEAACCINPUT))!=TRIM(UPPER(UAT.PLANVEAACCINPUT)) THEN 1 ELSE 0 END) AS DIFF_PLANVEAACCINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.PLANVEAACCVALUE))!=TRIM(UPPER(UAT.PLANVEAACCVALUE)) THEN 1 ELSE 0 END) AS DIFF_PLANVEAACCVALUE
,SUM(CASE WHEN TRIM(UPPER(PROD.NUMPLANINTERVAINPUT))!=TRIM(UPPER(UAT.NUMPLANINTERVAINPUT)) THEN 1 ELSE 0 END) AS DIFF_NUMPLANINTERVAINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.NUMPLANINTERVAVALUE))!=TRIM(UPPER(UAT.NUMPLANINTERVAVALUE)) THEN 1 ELSE 0 END) AS DIFF_NUMPLANINTERVAVALUE
