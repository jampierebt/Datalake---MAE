...
,SUM(CASE WHEN TRIM(UPPER(PROD.NUMEROPOLIZAPADREINPUT))!=TRIM(UPPER(UAT.NUMEROPOLIZAPADREINPUT)) THEN 1 ELSE 0 END) AS DIFF_NUMEROPOLIZAPADREINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.NUMEROPOLIZAPADREVALUE))!=TRIM(UPPER(UAT.NUMEROPOLIZAPADREVALUE)) THEN 1 ELSE 0 END) AS DIFF_NUMEROPOLIZAPADREVALUE
