...
,SUM(CASE WHEN TRIM(UPPER(PROD.OPCIONPLANPCINPUT))!=TRIM(UPPER(UAT.OPCIONPLANPCINPUT)) THEN 1 ELSE 0 END) AS DIFF_OPCIONPLANPCINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.OPCIONPLANPCVALUE))!=TRIM(UPPER(UAT.OPCIONPLANPCVALUE)) THEN 1 ELSE 0 END) AS DIFF_OPCIONPLANPCVALUE
