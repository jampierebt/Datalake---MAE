...
,SUM(CASE WHEN TRIM(UPPER(PROD.PLANVIDAESTUDIOSINPUT))!=TRIM(UPPER(UAT.PLANVIDAESTUDIOSINPUT)) THEN 1 ELSE 0 END) AS DIFF_PLANVIDAESTUDIOSINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.PLANVIDAESTUDIOSVALUE))!=TRIM(UPPER(UAT.PLANVIDAESTUDIOSVALUE)) THEN 1 ELSE 0 END) AS DIFF_PLANVIDAESTUDIOSVALUE
