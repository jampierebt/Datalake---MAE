...
,SUM(CASE WHEN TRIM(UPPER(PROD.COBFALLECACCTPINPUT))!=TRIM(UPPER(UAT.COBFALLECACCTPINPUT)) THEN 1 ELSE 0 END) AS DIFF_COBFALLECACCTPINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.COBFALLECACCTPVALUE))!=TRIM(UPPER(UAT.COBFALLECACCTPVALUE)) THEN 1 ELSE 0 END) AS DIFF_COBFALLECACCTPVALUE
,SUM(CASE WHEN TRIM(UPPER(PROD.COBFALLECACCTAINPUT))!=TRIM(UPPER(UAT.COBFALLECACCTAINPUT)) THEN 1 ELSE 0 END) AS DIFF_COBFALLECACCTAINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.COBFALLECACCTAVALUE))!=TRIM(UPPER(UAT.COBFALLECACCTAVALUE)) THEN 1 ELSE 0 END) AS DIFF_COBFALLECACCTAVALUE
...
,SUM(CASE WHEN TRIM(UPPER(PROD.COBINDEMHOSPINPUT))!=TRIM(UPPER(UAT.COBINDEMHOSPINPUT)) THEN 1 ELSE 0 END) AS DIFF_COBINDEMHOSPINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.COBINDEMHOSPVALUE))!=TRIM(UPPER(UAT.COBINDEMHOSPVALUE)) THEN 1 ELSE 0 END) AS DIFF_COBINDEMHOSPVALUE
,SUM(CASE WHEN TRIM(UPPER(PROD.COBINDEMHOSPUCIINPUT))!=TRIM(UPPER(UAT.COBINDEMHOSPUCIINPUT)) THEN 1 ELSE 0 END) AS DIFF_COBINDEMHOSPUCIINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.COBINDEMHOSPUCIVALUE))!=TRIM(UPPER(UAT.COBINDEMHOSPUCIVALUE)) THEN 1 ELSE 0 END) AS DIFF_COBINDEMHOSPUCIVALUE
...
FROM iter-data-storage-pv-uat.acsele_data.POLVIDATOTALPROTEGIDA_raw UAT 
INNER JOIN interseguro-data.acsele_data.POLVIDATOTALPROTEGIDA_raw PROD 
ON UAT.PK = PROD.PK