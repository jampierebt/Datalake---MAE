...
,SUM(CASE WHEN TRIM(UPPER(PROD.CAPITALASEGFALLECTPINPUT))!=TRIM(UPPER(UAT.CAPITALASEGFALLECTPINPUT)) THEN 1 ELSE 0 END) AS DIFF_CAPITALASEGFALLECTPINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.CAPITALASEGFALLECTPVALUE))!=TRIM(UPPER(UAT.CAPITALASEGFALLECTPVALUE)) THEN 1 ELSE 0 END) AS DIFF_CAPITALASEGFALLECTPVALUE
,SUM(CASE WHEN TRIM(UPPER(PROD.CAPITALASEGFALLECTAINPUT))!=TRIM(UPPER(UAT.CAPITALASEGFALLECTAINPUT)) THEN 1 ELSE 0 END) AS DIFF_CAPITALASEGFALLECTAINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.CAPITALASEGFALLECTAVALUE))!=TRIM(UPPER(UAT.CAPITALASEGFALLECTAVALUE)) THEN 1 ELSE 0 END) AS DIFF_CAPITALASEGFALLECTAVALUE
,SUM(CASE WHEN TRIM(UPPER(PROD.TASAANUALFALLECACCTPINPUT))!=TRIM(UPPER(UAT.TASAANUALFALLECACCTPINPUT)) THEN 1 ELSE 0 END) AS DIFF_TASAANUALFALLECACCTPINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.TASAANUALFALLECACCTPVALUE))!=TRIM(UPPER(UAT.TASAANUALFALLECACCTPVALUE)) THEN 1 ELSE 0 END) AS DIFF_TASAANUALFALLECACCTPVALUE
,SUM(CASE WHEN TRIM(UPPER(PROD.TASAANUALFALLECACCTAINPUT))!=TRIM(UPPER(UAT.TASAANUALFALLECACCTAINPUT)) THEN 1 ELSE 0 END) AS DIFF_TASAANUALFALLECACCTAINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.TASAANUALFALLECACCTAVALUE))!=TRIM(UPPER(UAT.TASAANUALFALLECACCTAVALUE)) THEN 1 ELSE 0 END) AS DIFF_TASAANUALFALLECACCTAVALUE
,SUM(CASE WHEN TRIM(UPPER(PROD.PRIMAANUALFALLECACCTPINPUT))!=TRIM(UPPER(UAT.PRIMAANUALFALLECACCTPINPUT)) THEN 1 ELSE 0 END) AS DIFF_PRIMAANUALFALLECACCTPINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.PRIMAANUALFALLECACCTPVALUE))!=TRIM(UPPER(UAT.PRIMAANUALFALLECACCTPVALUE)) THEN 1 ELSE 0 END) AS DIFF_PRIMAANUALFALLECACCTPVALUE
,SUM(CASE WHEN TRIM(UPPER(PROD.PRIMAANUALFALLECACCTAINPUT))!=TRIM(UPPER(UAT.PRIMAANUALFALLECACCTAINPUT)) THEN 1 ELSE 0 END) AS DIFF_PRIMAANUALFALLECACCTAINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.PRIMAANUALFALLECACCTAVALUE))!=TRIM(UPPER(UAT.PRIMAANUALFALLECACCTAVALUE)) THEN 1 ELSE 0 END) AS DIFF_PRIMAANUALFALLECACCTAVALUE
,SUM(CASE WHEN TRIM(UPPER(PROD.REASEGCUMULOFALLACCTPINPUT))!=TRIM(UPPER(UAT.REASEGCUMULOFALLACCTPINPUT)) THEN 1 ELSE 0 END) AS DIFF_REASEGCUMULOFALLACCTPINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.REASEGCUMULOFALLACCTPVALUE))!=TRIM(UPPER(UAT.REASEGCUMULOFALLACCTPVALUE)) THEN 1 ELSE 0 END) AS DIFF_REASEGCUMULOFALLACCTPVALUE
,SUM(CASE WHEN TRIM(UPPER(PROD.REASEGCUMULOFALLACCTAINPUT))!=TRIM(UPPER(UAT.REASEGCUMULOFALLACCTAINPUT)) THEN 1 ELSE 0 END) AS DIFF_REASEGCUMULOFALLACCTAINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.REASEGCUMULOFALLACCTAVALUE))!=TRIM(UPPER(UAT.REASEGCUMULOFALLACCTAVALUE)) THEN 1 ELSE 0 END) AS DIFF_REASEGCUMULOFALLACCTAVALUE
...
,SUM(CASE WHEN TRIM(UPPER(PROD.CAPITALASEGINDEMINPUT))!=TRIM(UPPER(UAT.CAPITALASEGINDEMINPUT)) THEN 1 ELSE 0 END) AS DIFF_CAPITALASEGINDEMINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.CAPITALASEGINDEMVALUE))!=TRIM(UPPER(UAT.CAPITALASEGINDEMVALUE)) THEN 1 ELSE 0 END) AS DIFF_CAPITALASEGINDEMVALUE
,SUM(CASE WHEN TRIM(UPPER(PROD.CAPITALASEGINDEMUCIINPUT))!=TRIM(UPPER(UAT.CAPITALASEGINDEMUCIINPUT)) THEN 1 ELSE 0 END) AS DIFF_CAPITALASEGINDEMUCIINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.CAPITALASEGINDEMUCIVALUE))!=TRIM(UPPER(UAT.CAPITALASEGINDEMUCIVALUE)) THEN 1 ELSE 0 END) AS DIFF_CAPITALASEGINDEMUCIVALUE
,SUM(CASE WHEN TRIM(UPPER(PROD.TASAANUALINDEMINPUT))!=TRIM(UPPER(UAT.TASAANUALINDEMINPUT)) THEN 1 ELSE 0 END) AS DIFF_TASAANUALINDEMINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.TASAANUALINDEMVALUE))!=TRIM(UPPER(UAT.TASAANUALINDEMVALUE)) THEN 1 ELSE 0 END) AS DIFF_TASAANUALINDEMVALUE
,SUM(CASE WHEN TRIM(UPPER(PROD.TASAANUALINDEMUCIINPUT))!=TRIM(UPPER(UAT.TASAANUALINDEMUCIINPUT)) THEN 1 ELSE 0 END) AS DIFF_TASAANUALINDEMUCIINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.TASAANUALINDEMUCIVALUE))!=TRIM(UPPER(UAT.TASAANUALINDEMUCIVALUE)) THEN 1 ELSE 0 END) AS DIFF_TASAANUALINDEMUCIVALUE
,SUM(CASE WHEN TRIM(UPPER(PROD.PRIMAANUALINDEMINPUT))!=TRIM(UPPER(UAT.PRIMAANUALINDEMINPUT)) THEN 1 ELSE 0 END) AS DIFF_PRIMAANUALINDEMINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.PRIMAANUALINDEMVALUE))!=TRIM(UPPER(UAT.PRIMAANUALINDEMVALUE)) THEN 1 ELSE 0 END) AS DIFF_PRIMAANUALINDEMVALUE
,SUM(CASE WHEN TRIM(UPPER(PROD.PRIMAANUALINDEMUCIINPUT))!=TRIM(UPPER(UAT.PRIMAANUALINDEMUCIINPUT)) THEN 1 ELSE 0 END) AS DIFF_PRIMAANUALINDEMUCIINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.PRIMAANUALINDEMUCIVALUE))!=TRIM(UPPER(UAT.PRIMAANUALINDEMUCIVALUE)) THEN 1 ELSE 0 END) AS DIFF_PRIMAANUALINDEMUCIVALUE
