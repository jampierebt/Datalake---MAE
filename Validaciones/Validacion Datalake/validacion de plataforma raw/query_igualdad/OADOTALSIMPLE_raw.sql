...
,SUM(CASE WHEN TRIM(UPPER(PROD.EDADMINIMAINPUT))!=TRIM(UPPER(UAT.EDADMINIMAINPUT)) THEN 1 ELSE 0 END) AS DIFF_EDADMINIMAINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.EDADMINIMAVALUE))!=TRIM(UPPER(UAT.EDADMINIMAVALUE)) THEN 1 ELSE 0 END) AS DIFF_EDADMINIMAVALUE
,SUM(CASE WHEN TRIM(UPPER(PROD.EDADMAXIMAINPUT))!=TRIM(UPPER(UAT.EDADMAXIMAINPUT)) THEN 1 ELSE 0 END) AS DIFF_EDADMAXIMAINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.EDADMAXIMAVALUE))!=TRIM(UPPER(UAT.EDADMAXIMAVALUE)) THEN 1 ELSE 0 END) AS DIFF_EDADMAXIMAVALUE
...
,SUM(CASE WHEN TRIM(UPPER(PROD.EDADPERMANINPUT))!=TRIM(UPPER(UAT.EDADPERMANINPUT)) THEN 1 ELSE 0 END) AS DIFF_EDADPERMANINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.EDADPERMANVALUE))!=TRIM(UPPER(UAT.EDADPERMANVALUE)) THEN 1 ELSE 0 END) AS DIFF_EDADPERMANVALUE
...
,SUM(CASE WHEN TRIM(UPPER(PROD.APEPATERNOBENCIVINPUT))!=TRIM(UPPER(UAT.APEPATERNOBENCIVINPUT)) THEN 1 ELSE 0 END) AS DIFF_APEPATERNOBENCIVINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.APEPATERNOBENCIVVALUE))!=TRIM(UPPER(UAT.APEPATERNOBENCIVVALUE)) THEN 1 ELSE 0 END) AS DIFF_APEPATERNOBENCIVVALUE
,SUM(CASE WHEN TRIM(UPPER(PROD.APEMATERNOBENCIVINPUT))!=TRIM(UPPER(UAT.APEMATERNOBENCIVINPUT)) THEN 1 ELSE 0 END) AS DIFF_APEMATERNOBENCIVINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.APEMATERNOBENCIVVALUE))!=TRIM(UPPER(UAT.APEMATERNOBENCIVVALUE)) THEN 1 ELSE 0 END) AS DIFF_APEMATERNOBENCIVVALUE
,SUM(CASE WHEN TRIM(UPPER(PROD.NOMBRESBENCIVINPUT))!=TRIM(UPPER(UAT.NOMBRESBENCIVINPUT)) THEN 1 ELSE 0 END) AS DIFF_NOMBRESBENCIVINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.NOMBRESBENCIVVALUE))!=TRIM(UPPER(UAT.NOMBRESBENCIVVALUE)) THEN 1 ELSE 0 END) AS DIFF_NOMBRESBENCIVVALUE
,SUM(CASE WHEN TRIM(UPPER(PROD.FECHANACBENCIVINPUT))!=TRIM(UPPER(UAT.FECHANACBENCIVINPUT)) THEN 1 ELSE 0 END) AS DIFF_FECHANACBENCIVINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.FECHANACBENCIVVALUE))!=TRIM(UPPER(UAT.FECHANACBENCIVVALUE)) THEN 1 ELSE 0 END) AS DIFF_FECHANACBENCIVVALUE
,SUM(CASE WHEN TRIM(UPPER(PROD.DOCIDENTIDADBENCIVINPUT))!=TRIM(UPPER(UAT.DOCIDENTIDADBENCIVINPUT)) THEN 1 ELSE 0 END) AS DIFF_DOCIDENTIDADBENCIVINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.DOCIDENTIDADBENCIVVALUE))!=TRIM(UPPER(UAT.DOCIDENTIDADBENCIVVALUE)) THEN 1 ELSE 0 END) AS DIFF_DOCIDENTIDADBENCIVVALUE
,SUM(CASE WHEN TRIM(UPPER(PROD.PARENTESCOBENCIVINPUT))!=TRIM(UPPER(UAT.PARENTESCOBENCIVINPUT)) THEN 1 ELSE 0 END) AS DIFF_PARENTESCOBENCIVINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.PARENTESCOBENCIVVALUE))!=TRIM(UPPER(UAT.PARENTESCOBENCIVVALUE)) THEN 1 ELSE 0 END) AS DIFF_PARENTESCOBENCIVVALUE
,SUM(CASE WHEN TRIM(UPPER(PROD.DISTRIBUCIONBENCIVINPUT))!=TRIM(UPPER(UAT.DISTRIBUCIONBENCIVINPUT)) THEN 1 ELSE 0 END) AS DIFF_DISTRIBUCIONBENCIVINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.DISTRIBUCIONBENCIVVALUE))!=TRIM(UPPER(UAT.DISTRIBUCIONBENCIVVALUE)) THEN 1 ELSE 0 END) AS DIFF_DISTRIBUCIONBENCIVVALUE
,SUM(CASE WHEN TRIM(UPPER(PROD.APEPATERNOBENCVINPUT))!=TRIM(UPPER(UAT.APEPATERNOBENCVINPUT)) THEN 1 ELSE 0 END) AS DIFF_APEPATERNOBENCVINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.APEPATERNOBENCVVALUE))!=TRIM(UPPER(UAT.APEPATERNOBENCVVALUE)) THEN 1 ELSE 0 END) AS DIFF_APEPATERNOBENCVVALUE
,SUM(CASE WHEN TRIM(UPPER(PROD.APEMATERNOBENCVINPUT))!=TRIM(UPPER(UAT.APEMATERNOBENCVINPUT)) THEN 1 ELSE 0 END) AS DIFF_APEMATERNOBENCVINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.APEMATERNOBENCVVALUE))!=TRIM(UPPER(UAT.APEMATERNOBENCVVALUE)) THEN 1 ELSE 0 END) AS DIFF_APEMATERNOBENCVVALUE
,SUM(CASE WHEN TRIM(UPPER(PROD.NOMBRESBENCVINPUT))!=TRIM(UPPER(UAT.NOMBRESBENCVINPUT)) THEN 1 ELSE 0 END) AS DIFF_NOMBRESBENCVINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.NOMBRESBENCVVALUE))!=TRIM(UPPER(UAT.NOMBRESBENCVVALUE)) THEN 1 ELSE 0 END) AS DIFF_NOMBRESBENCVVALUE
,SUM(CASE WHEN TRIM(UPPER(PROD.FECHANACBENCVINPUT))!=TRIM(UPPER(UAT.FECHANACBENCVINPUT)) THEN 1 ELSE 0 END) AS DIFF_FECHANACBENCVINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.FECHANACBENCVVALUE))!=TRIM(UPPER(UAT.FECHANACBENCVVALUE)) THEN 1 ELSE 0 END) AS DIFF_FECHANACBENCVVALUE
,SUM(CASE WHEN TRIM(UPPER(PROD.DOCIDENTIDADBENCVINPUT))!=TRIM(UPPER(UAT.DOCIDENTIDADBENCVINPUT)) THEN 1 ELSE 0 END) AS DIFF_DOCIDENTIDADBENCVINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.DOCIDENTIDADBENCVVALUE))!=TRIM(UPPER(UAT.DOCIDENTIDADBENCVVALUE)) THEN 1 ELSE 0 END) AS DIFF_DOCIDENTIDADBENCVVALUE
,SUM(CASE WHEN TRIM(UPPER(PROD.PARENTESCOBENCVINPUT))!=TRIM(UPPER(UAT.PARENTESCOBENCVINPUT)) THEN 1 ELSE 0 END) AS DIFF_PARENTESCOBENCVINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.PARENTESCOBENCVVALUE))!=TRIM(UPPER(UAT.PARENTESCOBENCVVALUE)) THEN 1 ELSE 0 END) AS DIFF_PARENTESCOBENCVVALUE
,SUM(CASE WHEN TRIM(UPPER(PROD.DISTRIBUCIONBENCVINPUT))!=TRIM(UPPER(UAT.DISTRIBUCIONBENCVINPUT)) THEN 1 ELSE 0 END) AS DIFF_DISTRIBUCIONBENCVINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.DISTRIBUCIONBENCVVALUE))!=TRIM(UPPER(UAT.DISTRIBUCIONBENCVVALUE)) THEN 1 ELSE 0 END) AS DIFF_DISTRIBUCIONBENCVVALUE
...
FROM iter-data-storage-pv-uat.acsele_data.OADOTALSIMPLE_raw UAT 
INNER JOIN interseguro-data.acsele_data.OADOTALSIMPLE_raw PROD 
ON UAT.PK = PROD.PK