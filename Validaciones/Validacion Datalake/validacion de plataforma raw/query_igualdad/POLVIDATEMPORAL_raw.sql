...
,SUM(CASE WHEN TRIM(UPPER(PROD.DURACIONPOLINPUT))!=TRIM(UPPER(UAT.DURACIONPOLINPUT)) THEN 1 ELSE 0 END) AS DIFF_DURACIONPOLINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.DURACIONPOLVALUE))!=TRIM(UPPER(UAT.DURACIONPOLVALUE)) THEN 1 ELSE 0 END) AS DIFF_DURACIONPOLVALUE
