...
,SUM(CASE WHEN TRIM(UPPER(PROD.NUMTIENDAINPUT))!=TRIM(UPPER(UAT.NUMTIENDAINPUT)) THEN 1 ELSE 0 END) AS DIFF_NUMTIENDAINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.NUMTIENDAVALUE))!=TRIM(UPPER(UAT.NUMTIENDAVALUE)) THEN 1 ELSE 0 END) AS DIFF_NUMTIENDAVALUE
,SUM(CASE WHEN TRIM(UPPER(PROD.FECHAULTIMAFACTURACIONINPUT))!=TRIM(UPPER(UAT.FECHAULTIMAFACTURACIONINPUT)) THEN 1 ELSE 0 END) AS DIFF_FECHAULTIMAFACTURACIONINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.FECHAULTIMAFACTURACIONVALUE))!=TRIM(UPPER(UAT.FECHAULTIMAFACTURACIONVALUE)) THEN 1 ELSE 0 END) AS DIFF_FECHAULTIMAFACTURACIONVALUE
