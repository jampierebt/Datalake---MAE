...
,SUM(CASE WHEN TRIM(UPPER(PROD.FECACTTARJETACTAINPUT))!=TRIM(UPPER(UAT.FECACTTARJETACTAINPUT)) THEN 1 ELSE 0 END) AS DIFF_FECACTTARJETACTAINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.FECACTTARJETACTAVALUE))!=TRIM(UPPER(UAT.FECACTTARJETACTAVALUE)) THEN 1 ELSE 0 END) AS DIFF_FECACTTARJETACTAVALUE
...
,SUM(CASE WHEN TRIM(UPPER(PROD.PLANPROTECCFINANCOHINPUT))!=TRIM(UPPER(UAT.PLANPROTECCFINANCOHINPUT)) THEN 1 ELSE 0 END) AS DIFF_PLANPROTECCFINANCOHINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.PLANPROTECCFINANCOHVALUE))!=TRIM(UPPER(UAT.PLANPROTECCFINANCOHVALUE)) THEN 1 ELSE 0 END) AS DIFF_PLANPROTECCFINANCOHVALUE