...
,SUM(CASE WHEN TRIM(UPPER(PROD.FECHANACVIDAINPUT))!=TRIM(UPPER(UAT.FECHANACVIDAINPUT)) THEN 1 ELSE 0 END) AS DIFF_FECHANACVIDAINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.FECHANACVIDAVALUE))!=TRIM(UPPER(UAT.FECHANACVIDAVALUE)) THEN 1 ELSE 0 END) AS DIFF_FECHANACVIDAVALUE
...
,SUM(CASE WHEN TRIM(UPPER(PROD.COBFALLECACCTRINPUT))!=TRIM(UPPER(UAT.COBFALLECACCTRINPUT)) THEN 1 ELSE 0 END) AS DIFF_COBFALLECACCTRINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.COBFALLECACCTRVALUE))!=TRIM(UPPER(UAT.COBFALLECACCTRVALUE)) THEN 1 ELSE 0 END) AS DIFF_COBFALLECACCTRVALUE
,SUM(CASE WHEN TRIM(UPPER(PROD.COBENFGRAVESINPUT))!=TRIM(UPPER(UAT.COBENFGRAVESINPUT)) THEN 1 ELSE 0 END) AS DIFF_COBENFGRAVESINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.COBENFGRAVESVALUE))!=TRIM(UPPER(UAT.COBENFGRAVESVALUE)) THEN 1 ELSE 0 END) AS DIFF_COBENFGRAVESVALUE
,SUM(CASE WHEN TRIM(UPPER(PROD.COBINVALIDEZACCINPUT))!=TRIM(UPPER(UAT.COBINVALIDEZACCINPUT)) THEN 1 ELSE 0 END) AS DIFF_COBINVALIDEZACCINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.COBINVALIDEZACCVALUE))!=TRIM(UPPER(UAT.COBINVALIDEZACCVALUE)) THEN 1 ELSE 0 END) AS DIFF_COBINVALIDEZACCVALUE
,SUM(CASE WHEN TRIM(UPPER(PROD.COBINVALIDEZTYPINPUT))!=TRIM(UPPER(UAT.COBINVALIDEZTYPINPUT)) THEN 1 ELSE 0 END) AS DIFF_COBINVALIDEZTYPINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.COBINVALIDEZTYPVALUE))!=TRIM(UPPER(UAT.COBINVALIDEZTYPVALUE)) THEN 1 ELSE 0 END) AS DIFF_COBINVALIDEZTYPVALUE
,SUM(CASE WHEN TRIM(UPPER(PROD.COBRENTAEDUCACIONALINPUT))!=TRIM(UPPER(UAT.COBRENTAEDUCACIONALINPUT)) THEN 1 ELSE 0 END) AS DIFF_COBRENTAEDUCACIONALINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.COBRENTAEDUCACIONALVALUE))!=TRIM(UPPER(UAT.COBRENTAEDUCACIONALVALUE)) THEN 1 ELSE 0 END) AS DIFF_COBRENTAEDUCACIONALVALUE
...
,SUM(CASE WHEN TRIM(UPPER(PROD.SOBREPRIMAINPUT))!=TRIM(UPPER(UAT.SOBREPRIMAINPUT)) THEN 1 ELSE 0 END) AS DIFF_SOBREPRIMAINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.SOBREPRIMAVALUE))!=TRIM(UPPER(UAT.SOBREPRIMAVALUE)) THEN 1 ELSE 0 END) AS DIFF_SOBREPRIMAVALUE
,SUM(CASE WHEN TRIM(UPPER(PROD.EXTRAPRIMAINPUT))!=TRIM(UPPER(UAT.EXTRAPRIMAINPUT)) THEN 1 ELSE 0 END) AS DIFF_EXTRAPRIMAINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.EXTRAPRIMAVALUE))!=TRIM(UPPER(UAT.EXTRAPRIMAVALUE)) THEN 1 ELSE 0 END) AS DIFF_EXTRAPRIMAVALUE
,SUM(CASE WHEN TRIM(UPPER(PROD.TEMPORALINPUT))!=TRIM(UPPER(UAT.TEMPORALINPUT)) THEN 1 ELSE 0 END) AS DIFF_TEMPORALINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.TEMPORALVALUE))!=TRIM(UPPER(UAT.TEMPORALVALUE)) THEN 1 ELSE 0 END) AS DIFF_TEMPORALVALUE
,SUM(CASE WHEN TRIM(UPPER(PROD.INDCESIONINPUT))!=TRIM(UPPER(UAT.INDCESIONINPUT)) THEN 1 ELSE 0 END) AS DIFF_INDCESIONINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.INDCESIONVALUE))!=TRIM(UPPER(UAT.INDCESIONVALUE)) THEN 1 ELSE 0 END) AS DIFF_INDCESIONVALUE
...
,SUM(CASE WHEN TRIM(UPPER(PROD.MONEDAAUXINPUT))!=TRIM(UPPER(UAT.MONEDAAUXINPUT)) THEN 1 ELSE 0 END) AS DIFF_MONEDAAUXINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.MONEDAAUXVALUE))!=TRIM(UPPER(UAT.MONEDAAUXVALUE)) THEN 1 ELSE 0 END) AS DIFF_MONEDAAUXVALUE
,SUM(CASE WHEN TRIM(UPPER(PROD.TABLARESCATEVEINPUT))!=TRIM(UPPER(UAT.TABLARESCATEVEINPUT)) THEN 1 ELSE 0 END) AS DIFF_TABLARESCATEVEINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.TABLARESCATEVEVALUE))!=TRIM(UPPER(UAT.TABLARESCATEVEVALUE)) THEN 1 ELSE 0 END) AS DIFF_TABLARESCATEVEVALUE
