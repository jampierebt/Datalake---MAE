...
,SUM(CASE WHEN TRIM(UPPER(PROD.PLANEXTRACASHFUNOINPUT))!=TRIM(UPPER(UAT.PLANEXTRACASHFUNOINPUT)) THEN 1 ELSE 0 END) AS DIFF_PLANEXTRACASHFUNOINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.PLANEXTRACASHFUNOVALUE))!=TRIM(UPPER(UAT.PLANEXTRACASHFUNOVALUE)) THEN 1 ELSE 0 END) AS DIFF_PLANEXTRACASHFUNOVALUE