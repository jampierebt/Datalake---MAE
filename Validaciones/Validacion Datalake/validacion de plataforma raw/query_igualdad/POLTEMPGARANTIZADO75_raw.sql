...
,SUM(CASE WHEN TRIM(UPPER(PROD.INDPRESTAMOSURAINPUT))!=TRIM(UPPER(UAT.INDPRESTAMOSURAINPUT)) THEN 1 ELSE 0 END) AS DIFF_INDPRESTAMOSURAINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.INDPRESTAMOSURAVALUE))!=TRIM(UPPER(UAT.INDPRESTAMOSURAVALUE)) THEN 1 ELSE 0 END) AS DIFF_INDPRESTAMOSURAVALUE
,SUM(CASE WHEN TRIM(UPPER(PROD.PORCENFGRAVESINPUT))!=TRIM(UPPER(UAT.PORCENFGRAVESINPUT)) THEN 1 ELSE 0 END) AS DIFF_PORCENFGRAVESINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.PORCENFGRAVESVALUE))!=TRIM(UPPER(UAT.PORCENFGRAVESVALUE)) THEN 1 ELSE 0 END) AS DIFF_PORCENFGRAVESVALUE
