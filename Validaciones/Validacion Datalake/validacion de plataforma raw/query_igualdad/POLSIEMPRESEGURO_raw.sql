...
,SUM(CASE WHEN TRIM(UPPER(PROD.FECHAPROXIMACADUCIDADINPUT))!=TRIM(UPPER(UAT.FECHAPROXIMACADUCIDADINPUT)) THEN 1 ELSE 0 END) AS DIFF_FECHAPROXIMACADUCIDADINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.FECHAPROXIMACADUCIDADVALUE))!=TRIM(UPPER(UAT.FECHAPROXIMACADUCIDADVALUE)) THEN 1 ELSE 0 END) AS DIFF_FECHAPROXIMACADUCIDADVALUE
...
FROM iter-data-storage-pv-uat.acsele_data.POLSIEMPRESEGURO_raw UAT 
INNER JOIN interseguro-data.acsele_data.POLSIEMPRESEGURO_raw PROD 
ON UAT.PK = PROD.PK