...
,SUM(CASE WHEN TRIM(UPPER(PROD.PROFESIONACTIVIDADINPUT))!=TRIM(UPPER(UAT.PROFESIONACTIVIDADINPUT)) THEN 1 ELSE 0 END) AS DIFF_PROFESIONACTIVIDADINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.PROFESIONACTIVIDADVALUE))!=TRIM(UPPER(UAT.PROFESIONACTIVIDADVALUE)) THEN 1 ELSE 0 END) AS DIFF_PROFESIONACTIVIDADVALUE
,SUM(CASE WHEN TRIM(UPPER(PROD.CLASEACCPERSINPUT))!=TRIM(UPPER(UAT.CLASEACCPERSINPUT)) THEN 1 ELSE 0 END) AS DIFF_CLASEACCPERSINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.CLASEACCPERSVALUE))!=TRIM(UPPER(UAT.CLASEACCPERSVALUE)) THEN 1 ELSE 0 END) AS DIFF_CLASEACCPERSVALUE
...
,SUM(CASE WHEN TRIM(UPPER(PROD.TIPOENDOSOPROPACCINPUT))!=TRIM(UPPER(UAT.TIPOENDOSOPROPACCINPUT)) THEN 1 ELSE 0 END) AS DIFF_TIPOENDOSOPROPACCINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.TIPOENDOSOPROPACCVALUE))!=TRIM(UPPER(UAT.TIPOENDOSOPROPACCVALUE)) THEN 1 ELSE 0 END) AS DIFF_TIPOENDOSOPROPACCVALUE
...
FROM iter-data-storage-pv-uat.acsele_data.POLSEGUROACCIDENTES_raw UAT 
INNER JOIN interseguro-data.acsele_data.POLSEGUROACCIDENTES_raw PROD 
ON UAT.PK = PROD.PK