...
,SUM(CASE WHEN TRIM(UPPER(PROD.PLANVIDAESTUDIOSPLUSINPUT))!=TRIM(UPPER(UAT.PLANVIDAESTUDIOSPLUSINPUT)) THEN 1 ELSE 0 END) AS DIFF_PLANVIDAESTUDIOSPLUSINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.PLANVIDAESTUDIOSPLUSVALUE))!=TRIM(UPPER(UAT.PLANVIDAESTUDIOSPLUSVALUE)) THEN 1 ELSE 0 END) AS DIFF_PLANVIDAESTUDIOSPLUSVALUE
