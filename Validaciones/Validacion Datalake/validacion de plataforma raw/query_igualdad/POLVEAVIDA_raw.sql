...
,SUM(CASE WHEN TRIM(UPPER(PROD.PLANVEAVIDAINPUT))!=TRIM(UPPER(UAT.PLANVEAVIDAINPUT)) THEN 1 ELSE 0 END) AS DIFF_PLANVEAVIDAINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.PLANVEAVIDAVALUE))!=TRIM(UPPER(UAT.PLANVEAVIDAVALUE)) THEN 1 ELSE 0 END) AS DIFF_PLANVEAVIDAVALUE
,SUM(CASE WHEN TRIM(UPPER(PROD.NUMPLANINTERVVINPUT))!=TRIM(UPPER(UAT.NUMPLANINTERVVINPUT)) THEN 1 ELSE 0 END) AS DIFF_NUMPLANINTERVVINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.NUMPLANINTERVVVALUE))!=TRIM(UPPER(UAT.NUMPLANINTERVVVALUE)) THEN 1 ELSE 0 END) AS DIFF_NUMPLANINTERVVVALUE
