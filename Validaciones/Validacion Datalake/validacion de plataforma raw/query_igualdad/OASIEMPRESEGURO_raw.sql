...
,SUM(CASE WHEN TRIM(UPPER(PROD.EDADMINIMAASEGTPINPUT))!=TRIM(UPPER(UAT.EDADMINIMAASEGTPINPUT)) THEN 1 ELSE 0 END) AS DIFF_EDADMINIMAASEGTPINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.EDADMINIMAASEGTPVALUE))!=TRIM(UPPER(UAT.EDADMINIMAASEGTPVALUE)) THEN 1 ELSE 0 END) AS DIFF_EDADMINIMAASEGTPVALUE
,SUM(CASE WHEN TRIM(UPPER(PROD.EDADMAXIMAASEGTPINPUT))!=TRIM(UPPER(UAT.EDADMAXIMAASEGTPINPUT)) THEN 1 ELSE 0 END) AS DIFF_EDADMAXIMAASEGTPINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.EDADMAXIMAASEGTPVALUE))!=TRIM(UPPER(UAT.EDADMAXIMAASEGTPVALUE)) THEN 1 ELSE 0 END) AS DIFF_EDADMAXIMAASEGTPVALUE
,SUM(CASE WHEN TRIM(UPPER(PROD.EDADPERMANASEGTPINPUT))!=TRIM(UPPER(UAT.EDADPERMANASEGTPINPUT)) THEN 1 ELSE 0 END) AS DIFF_EDADPERMANASEGTPINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.EDADPERMANASEGTPVALUE))!=TRIM(UPPER(UAT.EDADPERMANASEGTPVALUE)) THEN 1 ELSE 0 END) AS DIFF_EDADPERMANASEGTPVALUE
,SUM(CASE WHEN TRIM(UPPER(PROD.EDADMINIMAASEGTAINPUT))!=TRIM(UPPER(UAT.EDADMINIMAASEGTAINPUT)) THEN 1 ELSE 0 END) AS DIFF_EDADMINIMAASEGTAINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.EDADMINIMAASEGTAVALUE))!=TRIM(UPPER(UAT.EDADMINIMAASEGTAVALUE)) THEN 1 ELSE 0 END) AS DIFF_EDADMINIMAASEGTAVALUE
,SUM(CASE WHEN TRIM(UPPER(PROD.EDADMAXIMAASEGTAINPUT))!=TRIM(UPPER(UAT.EDADMAXIMAASEGTAINPUT)) THEN 1 ELSE 0 END) AS DIFF_EDADMAXIMAASEGTAINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.EDADMAXIMAASEGTAVALUE))!=TRIM(UPPER(UAT.EDADMAXIMAASEGTAVALUE)) THEN 1 ELSE 0 END) AS DIFF_EDADMAXIMAASEGTAVALUE
,SUM(CASE WHEN TRIM(UPPER(PROD.EDADPERMANASEGTAINPUT))!=TRIM(UPPER(UAT.EDADPERMANASEGTAINPUT)) THEN 1 ELSE 0 END) AS DIFF_EDADPERMANASEGTAINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.EDADPERMANASEGTAVALUE))!=TRIM(UPPER(UAT.EDADPERMANASEGTAVALUE)) THEN 1 ELSE 0 END) AS DIFF_EDADPERMANASEGTAVALUE
