...
,SUM(CASE WHEN TRIM(UPPER(PROD.FLGREGELIMINADO))!=TRIM(UPPER(UAT.FLGREGELIMINADO)) THEN 1 ELSE 0 END) AS DIFF_FLGREGELIMINADO
,SUM(CASE WHEN PROD.FECREGELIMINADO!=UAT.FECREGELIMINADO THEN 1 ELSE 0 END) AS DIFF_FECREGELIMINADO
,SUM(CASE WHEN PROD.FECREGINGRESO!=UAT.FECREGINGRESO THEN 1 ELSE 0 END) AS DIFF_FECREGINGRESO
,SUM(CASE WHEN PROD.FECACTUALIZACIONTABLA!=UAT.FECACTUALIZACIONTABLA THEN 1 ELSE 0 END) AS DIFF_FECACTUALIZACIONTABLA
FROM iter-data-storage-pv-uat.acsele_data.OAVIDAFREE_raw UAT 
INNER JOIN interseguro-data.acsele_data.OAVIDAFREE_raw PROD 
ON UAT.PK = PROD.PK