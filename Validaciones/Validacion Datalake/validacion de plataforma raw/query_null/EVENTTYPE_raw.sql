...
FROM iter-data-storage-pv-uat.acsele_data.EVENTTYPE_raw UAT 
INNER JOIN interseguro-data.acsele_data.EVENTTYPE_raw PROD 
ON UAT.EVENTTYPEID = PROD.EVENTTYPEID