...
,SUM(CASE WHEN TRIM(UPPER(PROD.MONTOMORAINPUT)) IS NULL AND TRIM(UPPER(UAT.MONTOMORAINPUT))="" THEN 1 ELSE 0 END) AS DIFF_MONTOMORAINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.MONTOMORAVALUE)) IS NULL AND TRIM(UPPER(UAT.MONTOMORAVALUE))="" THEN 1 ELSE 0 END) AS DIFF_MONTOMORAVALUE
,SUM(CASE WHEN TRIM(UPPER(PROD.FECHAULTPRIMAPAGADAINPUT)) IS NULL AND TRIM(UPPER(UAT.FECHAULTPRIMAPAGADAINPUT))="" THEN 1 ELSE 0 END) AS DIFF_FECHAULTPRIMAPAGADAINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.FECHAULTPRIMAPAGADAVALUE)) IS NULL AND TRIM(UPPER(UAT.FECHAULTPRIMAPAGADAVALUE))="" THEN 1 ELSE 0 END) AS DIFF_FECHAULTPRIMAPAGADAVALUE
,SUM(CASE WHEN TRIM(UPPER(PROD.PRIMACOMERCIALANUALINPUT)) IS NULL AND TRIM(UPPER(UAT.PRIMACOMERCIALANUALINPUT))="" THEN 1 ELSE 0 END) AS DIFF_PRIMACOMERCIALANUALINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.PRIMACOMERCIALANUALVALUE)) IS NULL AND TRIM(UPPER(UAT.PRIMACOMERCIALANUALVALUE))="" THEN 1 ELSE 0 END) AS DIFF_PRIMACOMERCIALANUALVALUE
...
FROM iter-data-storage-pv-uat.acsele_data.POLEDUCGARANTIZADA_raw UAT 
INNER JOIN interseguro-data.acsele_data.POLEDUCGARANTIZADA_raw PROD 
ON UAT.PK = PROD.PK