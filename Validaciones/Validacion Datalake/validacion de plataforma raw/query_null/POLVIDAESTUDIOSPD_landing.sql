SELECT SUM(CASE WHEN TRIM(UPPER(PROD.PLANVIDAESTUDIOSPLUSINPUT)) IS NULL AND TRIM(UPPER(UAT.PLANVIDAESTUDIOSPLUSINPUT))="" THEN 1 ELSE 0 END) AS DIFF_PLANVIDAESTUDIOSPLUSINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.PLANVIDAESTUDIOSPLUSVALUE)) IS NULL AND TRIM(UPPER(UAT.PLANVIDAESTUDIOSPLUSVALUE))="" THEN 1 ELSE 0 END) AS DIFF_PLANVIDAESTUDIOSPLUSVALUE
