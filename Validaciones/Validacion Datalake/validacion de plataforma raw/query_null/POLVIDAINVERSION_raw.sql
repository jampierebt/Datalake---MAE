...
,SUM(CASE WHEN TRIM(UPPER(PROD.NUMEROPOLIZAFLEXINPUT)) IS NULL AND TRIM(UPPER(UAT.NUMEROPOLIZAFLEXINPUT))="" THEN 1 ELSE 0 END) AS DIFF_NUMEROPOLIZAFLEXINPUT
,SUM(CASE WHEN TRIM(UPPER(PROD.NUMEROPOLIZAFLEXVALUE)) IS NULL AND TRIM(UPPER(UAT.NUMEROPOLIZAFLEXVALUE))="" THEN 1 ELSE 0 END) AS DIFF_NUMEROPOLIZAFLEXVALUE
...
,SUM(CASE WHEN TRIM(UPPER(PROD.INDPRESTAMOVALUE)) IS NULL AND TRIM(UPPER(UAT.INDPRESTAMOVALUE))="" THEN 1 ELSE 0 END) AS DIFF_INDPRESTAMOVALUE
,SUM(CASE WHEN TRIM(UPPER(PROD.FLGREGELIMINADO)) IS NULL AND TRIM(UPPER(UAT.FLGREGELIMINADO))="" THEN 1 ELSE 0 END) AS DIFF_FLGREGELIMINADO
