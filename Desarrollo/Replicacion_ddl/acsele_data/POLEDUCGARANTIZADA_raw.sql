CREATE OR REPLACE EXTERNAL TABLE `iter-data-storage-pv-uat.acsele_temp.POLEDUCGARANTIZADA_raw`
(
  AUDITDATE TIMESTAMP,
  PK NUMERIC,
  STATIC NUMERIC,
  ...
  MONTOMORAINPUT STRING,
  MONTOMORAVALUE STRING,
  FECHAULTPRIMAPAGADAINPUT STRING,
  FECHAULTPRIMAPAGADAVALUE STRING,
  PRIMACOMERCIALANUALINPUT STRING,
  PRIMACOMERCIALANUALVALUE STRING,
  FECHARECEPCIONGDCINPUT STRING,
  FECHARECEPCIONGDCVALUE STRING,
  FECHA_PROCESO DATETIME
)
OPTIONS (format="PARQUET",URIS=["gs://interseguro-datalake-alloy-uat-new/acsele_data/POLEDUCGARANTIZADA_raw/*.parquet"]);