CREATE OR REPLACE EXTERNAL TABLE `iter-data-storage-pv-uat.acsele_temp.POLVIDAINVERSION_raw`
(
  PK NUMERIC,
  STATIC NUMERIC,
  STATUS NUMERIC,
...
)OPTIONS (format="PARQUET",URIS=["gs://interseguro-datalake-alloy-uat-new/acsele_data/POLVIDAINVERSION_raw/*.parquet"]);