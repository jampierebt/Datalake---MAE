CREATE OR REPLACE EXTERNAL TABLE `iter-data-storage-pv-uat.acsele_temp.POLPLANGARANTIZADO_raw`
(
  AUDITDATE TIMESTAMP,
  PK NUMERIC,
  STATIC NUMERIC,
  ...
  FECHAGENPRIMAINPUT STRING,
  FECHAGENPRIMAVALUE STRING,
  ...
  OPCIONCUOTAEGINPUT STRING,
  OPCIONCUOTAEGVALUE STRING,
  INDRECARGOINPUT STRING,
  INDRECARGOVALUE STRING,
  ...
  OPCIONVIDAVALUE STRING,
  FECHA_PROCESO DATETIME
)
OPTIONS (format="PARQUET",URIS=["gs://interseguro-datalake-alloy-uat-new/acsele_data/POLPLANGARANTIZADO_raw/*.parquet"]);