CREATE OR REPLACE EXTERNAL TABLE `iter-data-storage-pv-uat.acsele_temp.POLPROTECCIONFAMILIAR_raw`
(
  AUDITDATE TIMESTAMP,
  PK STRING,
  STATIC STRING,
...
OPTIONS (format="PARQUET",URIS=["gs://interseguro-datalake-alloy-uat-new/acsele_data/POLPROTECCIONFAMILIAR_raw/*.parquet"]);