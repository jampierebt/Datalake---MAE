CREATE OR REPLACE EXTERNAL TABLE `iter-data-storage-pv-uat.acsele_temp.POLVIDAENTERA_raw`
(
  AUDITDATE TIMESTAMP,
  PK NUMERIC,
  STATIC NUMERIC,
  ...
  MONEDAAUXINPUT STRING,
  MONEDAAUXVALUE STRING,
  TABLARESCATEVEINPUT STRING,
  TABLARESCATEVEVALUE STRING,
  FECHA_PROCESO DATETIME
)
OPTIONS (format="PARQUET",URIS=["gs://interseguro-datalake-alloy-uat-new/acsele_data/POLVIDAENTERA_raw/*.parquet"]);