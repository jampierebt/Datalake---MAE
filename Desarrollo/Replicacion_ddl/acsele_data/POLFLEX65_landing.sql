CREATE OR REPLACE EXTERNAL TABLE `iter-data-storage-pv-uat.acsele_temp.POLFLEX65_landing`
(
  PK NUMERIC,
  STATIC NUMERIC,
  STATUS NUMERIC,
...
)OPTIONS (format="PARQUET",URIS=["gs://interseguro-datalake-alloy-uat-new/acsele_data/POLFLEX65_landing/*.parquet"]);