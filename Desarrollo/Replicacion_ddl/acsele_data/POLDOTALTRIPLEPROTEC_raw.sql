CREATE OR REPLACE EXTERNAL TABLE `iter-data-storage-pv-uat.acsele_temp.POLDOTALTRIPLEPROTEC_raw`
(
  AUDITDATE TIMESTAMP,
  PK NUMERIC,
  STATIC NUMERIC,
  ...
  INDPRESTAMOSURAINPUT STRING,
  INDPRESTAMOSURAVALUE STRING,
  PORCENFGRAVESINPUT STRING,
  PORCENFGRAVESVALUE STRING,
  FECHA_PROCESO DATETIME
)
OPTIONS (format="PARQUET",URIS=["gs://interseguro-datalake-alloy-uat-new/acsele_data/POLDOTALTRIPLEPROTEC_raw/*.parquet"]);