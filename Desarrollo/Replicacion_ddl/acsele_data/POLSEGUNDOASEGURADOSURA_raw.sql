CREATE OR REPLACE EXTERNAL TABLE `iter-data-storage-pv-uat.acsele_temp.POLSEGUNDOASEGURADOSURA_raw`
(
  AUDITDATE TIMESTAMP,
  PK NUMERIC,
  STATIC NUMERIC,
  ...
  NUMEROPOLIZAPADREINPUT STRING,
  NUMEROPOLIZAPADREVALUE STRING,
  FECHA_PROCESO DATETIME
)
OPTIONS (format="PARQUET",URIS=["gs://interseguro-datalake-alloy-uat-new/acsele_data/POLSEGUNDOASEGURADOSURA_raw/*.parquet"]);