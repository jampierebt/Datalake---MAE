...
-- ------------------------------------------------------------------------------------
EXPORT DATA OPTIONS(
URI='gs://interseguro-datalake-prd-landing/DEV/ODS/EXT_FLEX_RPT_FLEXRESUMEN/EXT_FLEX_RPT_FLEXRESUMEN-*.csv.gz',
FORMAT='CSV',
COMPRESSION='GZIP',
overwrite=true,
header=false,
...
,VIA_PAGO
,TIPO
FROM iter-data-storage-pv-uat.acsele_data.EXT_FLEX_RPT_FLEXRESUMEN_raw 
;
