...
PRM_PATH_PROY=/home/interseguro-data/prd

# Path DATALAKE - CLOUD STORAGE - [ AMBIENTE ]
PRM_AMBIENTE_DTLK=gs://interseguro-datalake-prd-landing/DEV
...
gcloud sql import csv --project=interseguro-data dev-analitica $linea \
