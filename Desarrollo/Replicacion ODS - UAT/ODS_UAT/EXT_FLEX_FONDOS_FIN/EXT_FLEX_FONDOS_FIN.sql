...
-- ------------------------------------------------------------------------------------
EXPORT DATA OPTIONS(
URI='gs://interseguro-datalake-prd-landing/UAT/ODS/EXT_FLEX_FONDOS_FIN/EXT_FLEX_FONDOS_FIN-*.csv.gz',
FORMAT='CSV',
COMPRESSION='GZIP',
overwrite=true,
header=false,
...
, CP_INTPRES
, SALDOPRESTAMO
FROM iter-data-storage-pv-uat.acsele_data.EXT_FLEX_FONDOS_FIN_raw 
;
