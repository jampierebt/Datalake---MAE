...
-- ------------------------------------------------------------------------------------
EXPORT DATA OPTIONS(
URI='gs://interseguro-datalake-prd-landing/PRD/ODS/EXT_FLEX_RPT_FLEXDETALLE/EXT_FLEX_RPT_FLEXDETALLE-*.csv.gz',
FORMAT='CSV',
COMPRESSION='GZIP',
overwrite=true,
header=false,
...
,CP_INTPRES
,SALDOPRESTAMO
FROM interseguro-data.acsele_data.EXT_FLEX_RPT_FLEXDETALLE_raw 
;
