...
# Nombre de la tabla
PRM_NOMBRE_TABLA=PERSONA_SINIESTRO_SEMAFORIZACION

# Path inicial del proceso -[ AMBIENTE ]
PRM_PATH_PROY=/home/interseguro-data/uat

# Path DATALAKE - CLOUD STORAGE - [ AMBIENTE ]
PRM_AMBIENTE_DTLK=gs://interseguro-datalake-prd-landing/UAT
...
gcloud sql import csv --project=interseguro-data uat-analitica $linea \
    --account=analitica-data@interseguro.com.pe \
    --database=postgres \
    --table="public.persona_siniestro_semaforizacion" \
