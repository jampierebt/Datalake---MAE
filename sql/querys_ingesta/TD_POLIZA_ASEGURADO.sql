      ...
      ,INS.AGREGATEDPARENTID AS ID_ASEGURADO
...
INNER JOIN INTERSEGURO.STPO_INSOBJPARTICIPATION INS
        ON INS.OPERATIONPK = COT.ID
WHERE NULLIF(TRIM(PRE.NUMEROPOLIZAINPUT),'') IS NOT NULL
    AND INS.ROL_ID=6755
    --AND TRUNC(COT.AUDITDATE,'DD')  BETWEEN TO_DATE('20220226','YYYYMMDD') AND TO_DATE('20220302','YYYYMMDD')
